	...
	if(isset($_POST['sbtn']))
{
	...
	{
		$pass=$_POST["current"];
		$result=mysqli_query($connect,"SELECT * FROM addadmin WHERE Admin_password='$pass' AND Admin_CPassword='$pass' AND Admin_ID ='$_SESSION[id]'");
                            ...
                            <form name = "updatAdmin" method="post" class="tm-signup-form" enctype="multipart/form-data" >
                                ...
                                <div class="form-group">
                                    <div class="col-12 col-sm-6">
										...
										<a href="EditProfile.php?edit&id=<?php echo $_SESSION['id'];?>" class="btn btn-danger" style="height:50px;margin-left:150%;margin-top:-40%;">Return</a>
                                    </div>
                                </div>
                            </form>
                        </div>
