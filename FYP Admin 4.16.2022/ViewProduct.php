...
<h6 style="margin-left:auto%;margin-top:auto%;"class="text-white text-capitalize ps-3"><input style="width:15%;height:35px;margin-left:auto%;" id="myInput" type="text" name="searchname" placeholder="Search Product " ></h6>
<hr>
<br>
<thead>
<tr class="tm-bg-gray">
