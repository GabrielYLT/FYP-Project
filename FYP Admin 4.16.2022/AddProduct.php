                        ...
                        <div class="col-12 ">
                            ...
                            <form action="" name= "addProduct" method="post" class="tm-signup-form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
									...
									<input placeholder="RM : " type="number" min="1.00" max="10000.00" step="0.05" name="price" class="form-control validate" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <button type="submit" name="sbtn" class="btn btn-secondary" value="submit" >Add Product 
                                        </button>
