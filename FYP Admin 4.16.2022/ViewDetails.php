                        ...
                        <div class="col-12">
                            <form name = "updatAdmin" method="post" class="tm-signup-form" enctype="multipart/form-data" >
								<div class="form-group">
									...
									<img class="rounded-circle" width="320px" img src="images/<?php echo $row['Product_Image'] ?>" required />
									</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $row['Product_Price']?>" type="number" min="1.00" max="10000.00" step="0.01" name="price" class="form-control validate" required>
									<span id="erroremail"></span>	
                                </div>	
                                <div class="form-group">
                                    <label for="phone">Product Stock  &nbsp;	</label>
                                    <input value="<?php echo $row['Product_Stock']?>" type="number" min="0.00" name="pstock"  size="10" class="form-control validate" required>
                                </div>
								<div class="select">
