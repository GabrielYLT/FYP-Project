  ...
  <body class="goto-here">
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-md-0">
              ...
              <?php
                ...
                echo "Formated:".date('D,m/d/y',$tm)."<br>";
              ?>       
    ...
    ?>
            <div class="col-md-3  mt-2">
                <div class="card" style="height:400px; margin-top:50px;" id="myDIV">
                     <a href="hello8.php?buy&id=<?php echo $row['Product_ID']?>">
                    ...
                    <div class="card-body" style="margin:20px;">
                        ...
                        <p class="card-text">
                            <a href="hello8.php?buy&id=<?php echo $row['Product_ID']?>" class="btn btn-primary btn-sm">
                                BUY NOW
                            </a>
