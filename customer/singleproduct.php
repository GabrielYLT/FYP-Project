      ...
      ?>
        ...
        <form class="form-inline" method="POST" action="cart.php?action=add&id=<?php echo $row ["Product_ID"];?>">
               <div class="col-md-5">
                   ...
                   <img type="hidden_image" src="Admin/images/<?php echo $row["Product_Image"];?>" style="width:500px">
               </div>
               <div class="col-md-7" >
               <h4><?php echo $row["Product_Name"]?></h4>
                   ...
                   <h2>RM<?php echo $row["Product_Price"];?></h2>
                       <div class="form-group mb-2">
                           <input type="number" name="quantity" id="productQty" class="form-control" placeholder="Quantity" min=1 max=<?php echo $row["Product_Stock"];?> required><span><p style="color:grey; margin-left:20px;">Product Stock :<?php echo $row["Product_Stock"]?></p></span>
