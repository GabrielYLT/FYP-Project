        ...
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
				...
				<div class="col-md-12" id="cnum">
							...
							<input type="text" class="form-control" name="cardnum" id="card_num" placeholder="0000-0000-0000-0000" require="required">
							<span id="errorcard" style="color:red"></span>
				</div>
				<div class="col-md-12" id="cvv">
							<label for="ccvv">CVV</label>
							<input type="text" class="form-control" name="cardcvv" id="card_cvv" placeholder="000" require="required">
                ...
                <div class="col-md-12">
					...
					<button type="submit" href="menu.php" value="Place to Order" style="display:none" id="cardbutton" name="cardbutton" class="btn btn-primary py-3 px-4" onchange="myFunction(0)" onclick="payment_validation(),validateT()">Place to Order</button>
