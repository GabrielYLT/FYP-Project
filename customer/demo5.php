...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <div class="row">
    <?php
   $query = "SELECT * FROM product1 ORDER BY Product_ID ASC";
    ...
    ?>
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="demo6.php?buy&id=<?php echo $row['Product_ID']?>">
                    <img class="card-img-top" src="images/<?php echo $row['Product_Image'];?>" width="500px"  padding-left="30px";>
                </a> 
        <div class="card-body">
        ...
        <div class = "card-footer">
                            <a href="demo6.php?buy&id=<?php echo $row['Product_ID']?>" class="btn btn-primary btn-sm">
                                BUY NOW
                            </a>
                            <a href="demo6.php?id=<?php echo $row['Product_ID']?>" class="btn btn-primary btn-sm">
                                GET MORE INFO
                            </a>
        </div>
    </div>
