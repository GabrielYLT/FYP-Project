...
if(isset($_POST["poc"]))
{
    if(isset($_SESSION["shopping_cart"]))
    {
        ...
        if(!in_array($_GET["id"],$item_array_id))
        {
            ...
            $item_array = array(
              'item_id' => $_GET["id"],
              'item_image'=>$_GET["himage"],
              'item_name' => $_GET["hname"],
              'item_price' => $_GET["hprice"],
              'item_quantity' =>$_GET["hquantity"],
              'item_price' =>$_GET["htotal"]
            );
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="main.php">Home</a></span> <span>Checkout Page</span></p>
    ...
    <div class="container">
            ...
            if(!empty($_SESSION["shopping_cart"]))
            {
              foreach($_SESSION["shopping_cart"] as $keys =>$values)
              {
                ?>
              <tr>
                  <td><img src=images/<?php echo $values["item_image"];?> width="100px;"></td>
                  <td><?php echo $values["item_name"];?></td>
                  <td>&nbsp;</td>
                  <td padding-right="10px;"><input class="text-center iquantity" onchange="subTotal()" type="number" value=<?php echo $values["item_quantity"];?> min=1></td>
                ...
                <div class="w-100"></div>
		            <div class="col-md-12">
		            	<div class="form-group">
		                  ...
		                  <select name="" id="" class="form-control" onchange="getOption()">
