		  ...
		  <form name="billing" class="billing-form" id="billing"  method="POST" action="payment_success.php">
				...
				<div class="row align-items-end">
					...
					<label for="firstname">Name</label>
	                  <input type="text" name="fname" id="username" class="form-control" value="<?php echo $row['Username']?>" required>
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-md-12">
	                  ...
	                  <input type="text" class="form-control" name="zip" value="<?php echo $row['User_Poscode'] ?>" required>
                ...
                <div class="col-md-12">
					...
					<button type="submit" href="menu.php" value="Place to Order"  style="display:none" id="cashbutton"  name="cashbutton"  class="btn btn-primary py-3 px-4" onchange="myFunction(1)" onclick="validateT(), this.form.submit()">Place to Order</button>
				</div>
                </div>
		</div>
		</form><!-- END -->
