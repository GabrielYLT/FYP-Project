    ...
    <section class="ftco-section ftco-cart">
            ...
            if(!empty($_SESSION["shopping_cart"]))
            {
              ...
              <tr>
                  ...
                  <td>&nbsp;</td>
                  <td><input class='text-center iquantity' onchange='subTotal()' type='number' value=<?php echo $values["item_quantity"]?> min='1' max='10'></td>
                  <td>RM<?php echo $values["item_price"]?><input type='hidden' class='iprice' value=<?php echo $values["item_price"] ?>></td>
              ...
              <tr>
                ...
                <td>RM<?php echo number_format($total,2)?></span></td>
                <td></td>
            </tr>
            <?php
            }
    			...
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					...
    					<p class="d-flex total-price">
    						<span>Total</span>
    						<td>RM<?php echo number_format($subtotal,2)?></span</td>
    					</p>
    				</div>
