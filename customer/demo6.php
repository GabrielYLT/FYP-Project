...
<html lang="en">
  ...
  <body class="goto-here">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="main.php">Home</a></span> <span class="mr-2"></span> <span><a href="singleproduct.php">Single Product Page</a></span></p>
            <h1 class="mb-0 bread">Single Product Page</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    if(isset($_GET["buy"]))
    {
      ...
      ?>
        <div class="row mt-3">
        <form class="form-inline" method="POST" action="cart.php?action=add&id=<?php echo $row ["Product_ID"];?>">
               <div class="col-md-5">

                   <img type="hidden_image" src="images/<?php echo $row["Product_Image"];?>" style="width:500px">
               </div>
               <div class="col-md-7" >
               <h4><?php echo $row["Product_Name"]?></h4>
                   ...
                   <h2>RM<?php echo $row["Product_Price"];?></h2>
                       <div class="form-group mb-2">
                           <input type="text" name="quantity" id="productQty" class="form-control" placeholder="Quantity" min=1 value=1><span><p style="color:grey; margin-left:20px;">Product Stock :<?php echo $row["Product_Stock"]?></p></span>
...
?>
    <footer class="ftco-footer ftco-section" style="margin-top:80px;">
      <div class="container">
      	<div class="row">
      		<div class="mouse">
...
if(isset($_POST["add_to_cart"])) 	
{
	$cqty = $_POST["quantity"];  //retrive value from purchasefrm
	$balance = $row["Product_Stock"] - $cqty;  
	if($balance>=0)
	{
		

		mysqli_query($connect,"UPDATE product SET Product_Stock='$balance' where Product_ID='$productid'");// update product table
	}
	else
	{
		?>
