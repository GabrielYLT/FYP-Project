...
?>
<?php
$result = mysqli_query($connect,"SELECT customer_order.Order_ID,
                                        customer.Username,
                                        ...
                                        customer_order.payment_price,
                                        customer_order.quantity FROM
                                        (((customer_order INNER JOIN customer ON customer_order.customer_id = customer.ID)
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="main.php">Home</a></span> <span>View Order Page</span></p>
            <h1 class="mb-0 bread">View Order Page</h1>
          </div>
        </div>
      </div>
    </div>
    <?php
$result_payment = mysqli_query($connect,"SELECT DISTINCT customer_order.payment_id,customer_order.payment_price,customer_order.order_date,customer_order.Order_Status,customer_order.Payment_Status FROM customer_order INNER JOIN payment ON customer_order.payment_id = payment.payment_id");
  ...
  ?>
    <div class="container">
    			...
    			<div class="col-md-12 ftco-animate">
                    ...
                    while($row2 = mysqli_fetch_assoc($result_payment))
                    {
                    ?>
                    <tr>
                  <td><?php echo $row2["order_date"];?></td>
                  <td>&nbsp;</td>
                  <td>RM<?php echo (round($row2["payment_price"])."<br>");?></td>
                  <td><?php echo $row2["Order_Status"];?></td>
                  <td><?php echo $row2["Payment_Status"];?></td>
                  <td> <a href="demo18.php?id=<?php echo $row2['payment_id']?>" class="btn btn-primary btn-sm">View Details</td>
                </tr>
                <?php
                    }
                ?>
