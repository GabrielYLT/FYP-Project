    ...
    <section class="ftco-section ftco-cart">
            ...
            if(!empty($_SESSION["shopping_cart"]))
            {
              ...
              foreach($_SESSION["shopping_cart"] as $keys =>$values)
              {
                ...
                ?>
              <tr>
                  <td><img src="Admin/images/<?php echo $values["item_image"];?>" width="50" height="40"/></td>
                  <td><?php echo $values["item_name"];?></td>
                  <td>&nbsp;</td>
                  <td><input class='text-center iquantity' onchange='subTotal()' type='number' name="qty" value=<?php echo $values["item_quantity"]?> min='1' max='10'></td>
                  <td>RM<?php echo $values["item_price"]?><input type='hidden' class='iprice' name="price" value=<?php echo $values["item_price"] ?>></td>
    		...
    		<div class="row justify-content-end">
    			...
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					...
    					<p class="d-flex" style="color:black;font-weight:bold">
    						<span style="color:black"><b>Subtotal</b></span>
                <span style="margin-left:48px;"></span>
                <td>RM<span class='itotal' id="grandtotal" style="font-weight:bold;color:black"></span></td>
              </p>
    					<p class="d-flex">
    						<span style="color:black"><b>Delivery</b></span>
                <span></span>
    						<span style="color:black"><b>RM5.00</b></span>
    					</p>
    					<p class="d-flex">
    						<span style="color:red"><b>Discount</b></span>
                <span></span>
    						<span style="color:red"><b>RM3.00</b></span>
    					</p>
    					<hr>
                ...
                <span style="margin-left:48px;"></span>
    				...
    				<button type="submit" name="checkout" style="color:white" class="btn btn-primary py-3 px-4">Proceed to Checkout</button></p>
          </form>
          </div>
    		</div>
			</div>
