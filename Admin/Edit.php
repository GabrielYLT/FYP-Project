...
if(isset($_GET["edit"]))
{
	...
	?>
	<script>
    alert("Please select the correct admin account");
    </script>
    <?php
                        ...
                        <div class="col-12">
                            <form name = "updatAdmin" method="post" class="tm-signup-form" enctype="multipart/form-data" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $row['Admin_PhoneNo']?>" placeholder="01X-XXXXXXX(X)" id="phone" name="phone" type="tel" class="form-control validate"  pattern="[0-9]{3}-[0-9]{7/8}" required>
                                </div>
								<div class="select">
                                    <br>
                                ...
                                <div class="form-group">
                                    <div class="col-12 col-sm-6">
										...
										<a href="ChangePass.php?cPass&id=<?php echo $_SESSION['id'];?>" class="btn btn-info" style="height:50px;margin-left:65%;margin-top:-40%;">Change Password</a>
