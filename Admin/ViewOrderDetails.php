...
if(isset($_POST["sbtn"]))
{
	$confirm = $_POST["pstatus"];
    $status = $_POST["status"];
	
	
	mysqli_query($connect,"UPDATE customer_order SET Payment_Status ='$confirm',
                                               Order_Status='$status'
                        ...
                        <div class="col-12">
                            <form name = "updatAdmin" method="post" class="tm-signup-form" enctype="multipart/form-data" >
								...
								<div class="form-group">
                                    ...
                                    <input value="<?php echo $row1['payment_method']?>"  type="text" class="form-control" readonly>
                                </div>
								<div class="form-group">Total Price  &nbsp;	</label>
                                    <input value="RM<?php echo $row['payment_price']?>"  type="text" class="form-control" readonly>
                                </div>
								<div class="select" >Payment Status &nbsp;</label>
									<select class="form-control selectList" style="width:100%;Height:50%;" name="pstatus" id="status" required>
									<option value="<?php echo $row1['Payment_Status']?>"><?php echo $row['Payment_Status']?></option>
									<optgroup label="Status">
									<option value="Unpaid" class="text-danger">Unpaid</option>
									<option value="Processing" class="text-warning">Processing</option>
									<option value="Paid"  class="text-sucess">Paid</option>
									</select>
                                </div>
								<hr>
								<div class="select">Delivery Status &nbsp; </label>
									...
									<option value="Returned" class="text-danger">Returned</option>
