      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="main.php">Home</a></span> <span class="mr-2"><a href=""></a></span> <span>Edit Profile Page</span></p>
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 p-5">
                ...
                <div class="row-mt-3" style="width:360px;"> 
                    <div class="col-md-12"><label class="labels">Email</label><input type="email" name="useremail" class="form-control" placeholder="example@gmail.com" value="<?php echo $row['Email'];?>" disabled style="border-color:grey;"></div>
